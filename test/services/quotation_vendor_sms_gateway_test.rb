...
class QuotationVendorSmsGatewayTest < ActiveSupport::TestCase
  ...
  test "send_vendor_link uses approved dlt template, header, and content" do
    ...
    assert_equal "Dear G.TECH, PLOUGHMAN AGRO PRIVATE LIMITED requests you to review and accept the quotation proposal 123. Please submit the quotation using this link https://asa360.asaindia.org/q/secure-token", params["message"]
  end
